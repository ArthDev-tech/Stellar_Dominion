extends Control
## Displays one district definition: icon and reference to the .tres for editing.
## Assign definition in the Inspector to the corresponding resource in data/planet_districts/.

@export var definition: DistrictDefinitionResource
